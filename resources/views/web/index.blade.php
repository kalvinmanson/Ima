...
<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url({{ $slider->picture }})"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title">{{ $slider->description }}</div>
									<div class="home_slider_subtitle">{!! $slider->content !!}</div>
                                    @if($slider->link)
                                    <div class="home_slider_form_container">
                                    <a href="{{ $slider->link }}" class="btn btn-primary">VER MÁS...</a>
                                    </div>
                                    @endif
								</div>
							</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Instituto Moderno Americano</h2>
						<div class="section_subtitle"><p>La educación es la clave para el futuro del hombre y la posibilidad de actuar en un mundo mejor.|</p></div>
					</div>
				</div>
			</div>
			<div class="row features_row">
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<h3 class="feature_title">Modo IMA</h3>
						<div class="feature_text"><p>La mejor y mas moderna metodología en educación.</p></div>
					</div>
				</div>
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<h3 class="feature_title">Material de apoyo</h3>
						<div class="feature_text"><p>Contamos con material original de alta calidad académica.</p></div>
					</div>
				</div>
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<h3 class="feature_title">Educación TIC</h3>
						<div class="feature_text"><p>Plataforma deigital de educación con las herramientas mas modernas.</p></div>
					</div>
				</div>
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<h3 class="feature_title">Calidad en educación</h3>
						<div class="feature_text"><p>Graduados con excelentes resultados en pruebas SABER.</p></div>
					</div>
				</div>
